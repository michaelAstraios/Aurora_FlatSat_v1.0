#!/usr/bin/env python3
"""
FlatSat Simulator Plan PDF Generator

Converts the FlatSat Simulator Plan markdown file to a professional PDF document.
Uses reportlab for PDF generation with proper formatting, headers, and styling.
"""
    ...
    def parse_markdown_content(self):
        ...
        for line in lines:
            ...
            # Bullet points
                ...
                elements.append(Paragraph(f"• {text}", self.styles['CustomBullet']))
            ...
            # Status lines
                ...
                elements.append(Paragraph(line, self.styles['CustomStatus']))
                elements.append(Spacer(1, 12))
            ...
            # Regular paragraphs
                ...
                if line:
                    ...
                    if '**' in line:
                        # Simple replacement for single bold sections
                        line = line.replace('**', '<b>').replace('**', '</b>')
                    # Handle code snippets
                    if '`' in line:
                        line = line.replace('`', '<font name="Courier">').replace('`', '</font>')
